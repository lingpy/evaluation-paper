"""
Checking step: Fetch the data on EDICTOR and saved as a wordlist dataset. This script can output a wordlist file, but the main purpose is to check the consistency of tagging.   
